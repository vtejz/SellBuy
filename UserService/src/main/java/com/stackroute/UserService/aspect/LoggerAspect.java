...
public class LoggerAspect {
    ...
    @Before(value="execution(* com.stackroute.UserService.Controller..*(..)))")
    ...
    @AfterReturning(value="execution(* com.stackroute.UserService.Controller..*(..)))", returning = "result")
    ...
    @AfterThrowing("execution(* com.stackroute.UserService.Controller..*(..)))")
